...
// Prisma 7: connection URL lives in prisma.config.ts, not in the
// datasource block. See coding-standards.md.
generator client {
...
// ---------- EMAIL VERIFICATION ----------
// Separate from NextAuth's VerificationToken — scoped to a userId
// rather than an email identifier (registration + resend flows).
